...
export default function Home() {
  ...
  return <>
    <section className="hero"><div className="hero-backdrop"><Image src={`${basePath}/images/quattro-formaggi-hero.png`} alt="薪窯で焼き上げたクアトロフォルマッジ" fill priority sizes="100vw"/></div><div className="container hero-grid">
